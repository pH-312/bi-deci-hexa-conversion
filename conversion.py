...
Authors: Pauline Hughes and Ronald Sim
Created: October 2024
Version: 3.0
Description: Determines whether an input is in a valid base (binary, decimal or hexadecimal) and converts it into the other two bases.
Note: Created for a course assignment. Fonction use limited.
"""

from math import pow
import sys

nombre = (input("Input a value: "))
